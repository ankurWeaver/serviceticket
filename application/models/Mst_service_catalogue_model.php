...
class Mst_service_catalogue_model extends Common_model {
    
    public $table = 'mst_service_catalogue';
    public $primary_key = 'msc_id';
    
    function __construct() {
        parent::__construct('mst_service_catalogue','msc_id');
    }  
